...
import 'package:firebase_native_protocol_backend/firebase_native_protocol_backend.dart';
import 'package:test/test.dart';

void main() {
  group('FirebaseNativeProtocolBackend', () {
    ...
    test('signs in and calls a callable through the one-shot CLI', () async {
      final FirebaseNativeProtocolBackend backend =
          FirebaseNativeProtocolBackend(
        binaryPath: File('../../native/build/firebase_rest_cli').absolute.path,
      );
